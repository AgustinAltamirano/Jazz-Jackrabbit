...
MenuSeleccionMapa::MenuSeleccionMapa(QMainWindow* parent):
        ...
        opcion_mapa_1(this, NUM_MAPA_1, ANCHO_IMG_MAPA, ALTO_IMG_MAPA),

        opcion_mapa_2(this, NUM_MAPA_2, ANCHO_IMG_MAPA, ALTO_IMG_MAPA),

        opcion_mapa_custom(this, NUM_MAPA_CUST, ANCHO_IMG_MAPA, ALTO_IMG_MAPA) {
