...
const std::unordered_map<TipoRecogible, const std::string> AdminRecogibles::MAPA_TIPO_RECOGIBLE{
        {MONEDA_AGARRABLE, "moneda"},
        {GEMA_AGARRABLE, "gema"},
        {MUNICION_ARMA_1, "municion_arma1"},
        {MUNICION_ARMA_2, "municion_arma2"},
        {MUNICION_ARMA_3, "municion_arma3"},
        {FRUTA_PODRIDA, "fruta_podrida"},
...
AdminRecogibles::AdminRecogibles(SDL2pp::Renderer& renderer, LectorTexturas& lector_texturas, Camara& camara):
...
void AdminRecogibles::agregar_recogible(const TipoRecogible tipo_recogible,
    ...
    const SDL2pp::Rect dimensiones_corregidas = corregir_desfase_sprite(coords_sprite.at(0), dimensiones);

    ObjetoAnimado nuevo_recogible(0, renderer, lector_texturas.obtener_textura_items(), coords_sprite,
