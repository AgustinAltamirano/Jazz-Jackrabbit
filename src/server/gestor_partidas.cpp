...
Queue<ComandoDTO *> *GestorPartidas::crear_partida(Queue<SnapshotDTO> *cola_enviador, int32_t &id_cliente,
                                                   int32_t &codigo_partida, int8_t &capacidad_partidas) {
    Partida *nueva_partida = new Partida(cola_enviador, codigo_partida, id_cliente, capacidad_partidas);
...
Queue<ComandoDTO *> *GestorPartidas::unir_partida(Queue<SnapshotDTO> *cola_enviador,
                                          int32_t &codigo, int32_t &id_cliente) {
...
void GestorPartidas::join_partidas() {
    monitor_partidas.join_partidas();
}
