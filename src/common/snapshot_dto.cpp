...
SnapshotDTO::SnapshotDTO(): tipo_escenario(), bloques_escenario(), clientes(), fin_juego(false) {}

SnapshotDTO::SnapshotDTO(const TipoEscenario tipo_escenario):
        tipo_escenario(tipo_escenario), bloques_escenario(), clientes(), fin_juego(false) {}
