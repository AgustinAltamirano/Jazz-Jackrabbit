...
void SnapshotDTO::agregar_bloque_escenario(BloqueEscenarioDTO bloque_escenario) { bloques_escenario.push_back(bloque_escenario); }

std::vector<BloqueEscenarioDTO> SnapshotDTO::obtener_bloques_escenario() { return bloques_escenario; }
