...
estar y el escenario, en caso de que tal posición colisione con un bloque del escenario, le da una posición intermedia
de acuerdo con la posición original del jugador. Durante este chequeo se revisan las colisiones de los jugadores con los
...
chequean las colisiones con jugadores, enemigos y el entorno, haciendo los procedimientos correctos en caso de que haya
colisión.
...
entre otros, los cuales dependen del movimiento y posición del personaje, y si interactuó con el escenario de cierta forma.
...
las funcionalidades disponibles de `SDL2` siguiendo el paradigma de programación orientada a objetos y patrones de diseño
RAII.
...
clase `Cliente`, para luego procesar la última de estas (salvo que se trate de la primera snapshot, única que contiene
...
transcurrido del juego, de forma de mantener una tasa de 30 fotogramas por segundo. Permite saltear fotogramas en caso
...
primero el personaje asociado al cliente entre todos los recibidos en la snapshot, para poder actualizar la posición de
